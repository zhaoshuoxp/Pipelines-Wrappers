...
help(){
  ...
  This script will QC fastq files and align reads to the reference genome and transcriptome with STAR, depending on the species  passed by -s or the index and GTF passed by -i and -g, featureCounts and DESeq2 will be used for reads counting and differentially expressed genes test,
